...
export default function Sidebar({ page, setPage, count, onAddNew }) {
  return (
    <aside className="sidebar">
      ...
      <nav className="sidebar-nav">
        <div className="section-label" style={{ padding: '0 12px' }}>Coleção</div>
        <button className={`nav-item ${page === 'catalog' ? 'active' : ''}`} onClick={() => setPage('catalog')}>
